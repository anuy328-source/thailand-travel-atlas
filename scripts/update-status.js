...
// Notion表記ゆれ追加
add("TH-30", "ナコンラチャシマー", "ナコンラーチャシマー");
add("TH-41", "ウドンタニー", "ウドンターニー");
add("TH-39", "ノンブアランプー", "ノーンブアランプー", "ノンブアラムプー");
add("TH-51", "ラムプーン");
add("TH-58", "メーホーンソーン", "メーホンソーン");
add("TH-67", "ペッチャブン", "ペッチャブーン");
add("TH-47", "サコンナコン", "サコンナコーン");
add("TH-13", "パトゥムタニー", "パトゥムターニー");
add("TH-86", "チュムポン", "チュムポーン");
add("TH-35", "ヤソトーン", "ヤソートーン");
